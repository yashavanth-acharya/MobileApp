...
return(
  ...
  <Text  style={styles.icon} variant="titleLarge" >Add Sudent</Text>
    ...
    <View style={styles.textfieldview}>
    <TextInput mode="outlined" label="RoomNumber" style={styles.textfield} onChangeText={(values)=>{setshow4(show4)}} />
    </View>
